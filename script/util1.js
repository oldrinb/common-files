...
const util = {
  ...
  getGLErrorMessage: function(gl, errorCode) {
    switch (errorCode) {
      case gl.INVALID_ENUM: 
        return "WebGL: An unacceptable value has been specified for an " +
            "enumerated argument.";
      case gl.INVALID_VALUE:
        return "WebGL: A numeric argument is out of range."; 
      case gl.INVALID_OPERATION:
        return "WebGL: The specified command is not allowed for the current " +
            "state."; 
      case gl.INVALID_FRAMEBUFFER_OPERATION:
        return "WebGL: The currently bound framebuffer is not framebuffer " +
            "complete when trying to render to or to read from it.";
      case gl.OUT_OF_MEMORY:
        return "WebGL: Not enough memory is left to execute the command.";
      case gl.CONTEXT_LOST_WEBGL:
        return "WebGL: The WebGL context is lost.";
      default: return "WebGL: Unknown error.";
    }
  },
  ...
  displayErrorMessage: function(message, description) {
