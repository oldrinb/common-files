...
function Program([gl], vertexShaderSource, fragmentShaderSource) {
  ...
  this.getAttribLocation = function(name) {
    ...
    if (location !== -1) return location;
      ...
      throw ("Program.getAttribLocation: Attribute location not valid: "+ name);
    }
  };
  ...
  this.getUniformLocation = function(name) {
    let location = gl.getUniformLocation(program_, name);
    if (location !== null) return location;
    else {
      throw ("Program.getUniformLocation: Uniform location not valid: " + name);
    }
  };
